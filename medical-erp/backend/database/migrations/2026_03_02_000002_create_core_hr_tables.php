...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('employees', function (Blueprint $table) {
            ...
            // full_name يتم حسابه في Model Accessor بدلاً من العمود الافتراضي لتوافق قواعد البيانات
        ...
        // المفتاح الخارجي الذاتي (يجب إضافته بعد إنشاء الجدول)
